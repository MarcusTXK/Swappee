...
const Testing: NextPage = () => {
  ...
  return (
    <div>
      ...
      <MItemListingContainer isDataLoaded = {isDataLoaded}></MItemListingContainer>
   ...
   <MItemCard hasAvatar = {false} isLiked = {false} isUsed = {true} isListing = {true} username = {"yanhanapple<3"} title = "Apple For Sale" ></MItemCard> */}
   </div>
  );
};
